...
export MODEL_PATH="Qwen/Qwen2.5-7B-Instruct"  # Path to Qwen2.5 Coder model
export OUTPUT_PATH="/home/ubuntu/qwenReasoning/output/qwen2.5-7b-instruct-finetune-reasoning"
